module systolic_array_32x32 (
    ...
    always @(posedge clk) begin
        ...
        else skip_count <= skip_count + ({{15{1'b0}},sp0}+{{15{1'b0}},sp1}+{{15{1'b0}},sp2}+{{15{1'b0}},sp3}+{{15{1'b0}},sp4}+{{15{1'b0}},sp5}+{{15{1'b0}},sp6}+{{15{1'b0}},sp7}+{{15{1'b0}},sp8}+{{15{1'b0}},sp9}+{{15{1'b0}},sp10}+{{15{1'b0}},sp11}+{{15{1'b0}},sp12}+{{15{1'b0}},sp13}+{{15{1'b0}},sp14}+{{15{1'b0}},sp15}+{{15{1'b0}},sp16}+{{15{1'b0}},sp17}+{{15{1'b0}},sp18}+{{15{1'b0}},sp19}+{{15{1'b0}},sp20}+{{15{1'b0}},sp21}+{{15{1'b0}},sp22}+{{15{1'b0}},sp23}+{{15{1'b0}},sp24}+{{15{1'b0}},sp25}+{{15{1'b0}},sp26}+{{15{1'b0}},sp27}+{{15{1'b0}},sp28}+{{15{1'b0}},sp29}+{{15{1'b0}},sp30}+{{15{1'b0}},sp31});
    end
endmodule
